...
class _ProductManagementScreenState extends State<ProductManagementScreen> {
  ...
  void showAddSupplierDialog(Map<String, dynamic> product) {
    final availableSuppliers = suppliers.where((supplier) {
    ...
    if (availableSuppliers.isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('Todos os fornecedores já estão vinculados a este produto'),
                                      ...
                                      return Card(
                                        ...
                                        child: ListTile(
                                          ...
                                          subtitle: Column(
                                            ...
                                            children: [
                                              Text('Código: ${product['code'] ?? 'N/A'}'),
                                              if (product['category'] != null)
                                                Text('Categoria: ${product['category']}'),
                                              if (product['suppliers'] != null && (product['suppliers'] as List).isNotEmpty)
                                                Text(
                                          ...
                                          trailing: PopupMenuButton<String>(
                                            onSelected: (value) async {
                                              switch (value) {
                                                case 'edit':
                                                  showCreateProductDialog(product: product);
                                                  break;
                                                case 'suppliers':
                                                  showProductSuppliersDialog(product);
                                                  break;
                                                case 'delete':
