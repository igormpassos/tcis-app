...
class _SupplierManagementScreenState extends State<SupplierManagementScreen> {
  ...
  Future<void> deleteSupplier(int supplierId) async {
    try {
      ...
      await AdminService.deleteSupplier(
        token: token,
  ...
  void showCreateSupplierDialog({Map<String, dynamic>? supplier}) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: Text(supplier == null ? 'Criar Fornecedor' : 'Editar Fornecedor'),
        content: SizedBox(
  ...
  List<Map<String, dynamic>> get filteredSuppliers {
    ...
    return suppliers.where((supplier) {
      return (supplier['name']?.toLowerCase() ?? '').contains(searchQuery.toLowerCase()) ||
             (supplier['code']?.toLowerCase() ?? '').contains(searchQuery.toLowerCase()) ||
                                      ...
                                      return Card(
                                        ...
                                        child: ListTile(
                                          ...
                                          subtitle: Column(
                                            ...
                                            children: [
                                              Text('Código: ${supplier['code'] ?? 'N/A'}'),
                                              if (supplier['contact'] != null)
                                                Text('Contato: ${supplier['contact']}'),
